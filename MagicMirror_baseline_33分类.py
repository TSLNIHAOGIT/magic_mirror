...
repay_log_df['early_repay_days'] = (repay_log_df['due_date'] - repay_log_df['repay_date']).dt.days##2200-01-01时为负数
...
sub_example = pd.read_csv('submission/submission_example.csv', parse_dates=['repay_date'])
...
sub_example[['listing_id', 'repay_date', 'repay_amt']].to_csv('submission/sub.csv', index=False)
